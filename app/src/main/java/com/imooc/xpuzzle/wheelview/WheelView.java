...
package com.imooc.xpuzzle.wheelview;
...
public class WheelView extends View {
	...
	private void initData(Context context) {
		ADDITIONAL_ITEM_HEIGHT = dp2px(15);
		TEXT_SIZE = sp2px(17);
	 ...
	 * Notifies changing listeners
	 */
	public void notifyChangingListeners(int newValue) {
		for (OnWheelChangedListener listener : changingListeners) {
			listener.onChanged(this, currentItem, newValue);
		}
	}
    ...
    public void scrollZero(){
        scroll(0, SCROLLING_DURATION);
    }

    /**
     * 重绘(防止文字重叠)
     */
    public void invalidateTxt(){
        requestLayout();
        invalidate();
        scrollZero();
    }
    ...
    /**
     * 清空changingListeners监听
     */
    public void clearChangingListeners(){
